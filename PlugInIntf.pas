...
var // Declaration of all PL/SQL Developer callback functions
  ...
  // 240
  IDE_GetConnectionInfoEx: function(ix: Integer; var Username, Password, Database, ConnectAs: PChar): Bool; cdecl;
  IDE_FindConnection: function(Username, Database, ConnectAs: PChar): Integer; cdecl;
  IDE_AddConnection: function(Username, Password, Database, ConnectAs: PChar): Integer; cdecl;
  ...
  // 250
  IDE_GetConnectionInfoEx10: function(ix: Integer; var Username, Password, Database, ConnectAs, Edition, Workspace: PChar): Bool; cdecl;
  IDE_FindConnectionEx10: function(Username, Database, ConnectAs, Edition, Workspace: PChar): Integer; cdecl;
  IDE_AddConnectionEx10: function(Username, Password, Database, ConnectAs, Edition, Workspace: PChar): Integer; cdecl;
  IDE_GetConnectionTreeEx10: function(ix: Integer; var Description, Username, Password, Database, ConnectAs, Edition, Workspace: PChar; var ID, ParentID: integer): Bool; cdecl;
